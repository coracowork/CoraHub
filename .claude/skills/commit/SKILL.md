...
Generate well-formatted commit messages and commit staged changes for CoraHub.
...
- Added cora-extension.json manifest and install script
...
BREAKING CHANGE: cora-extension.json schema v1 is no longer supported.
```
